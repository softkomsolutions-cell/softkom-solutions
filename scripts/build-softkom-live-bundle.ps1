...
$muFiles = @(
    '000-softkom-organic-loader.php','softkom-public-acquisition.php','softkom-public-acquisition.js','softkom-strategy-request.php','softkom-sales-notifications.php','softkom-industry-funnel.php','softkom-industry-funnel.js','softkom-assessment-standalone.php','softkom-commercial-persistence.php','softkom-campaign-admin-redirect.php','softkom-organic-ai-discovery.php','softkom-organic-growth-pages.php','softkom-organic-growth-expansion.php','softkom-search-discovery.php','softkom-organic-attribution.php','softkom-indexnow.php','softkom-automated-qa.php'
)
