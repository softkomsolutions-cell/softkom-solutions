...
$muFiles = @(
    '000-softkom-organic-loader.php','softkom-public-acquisition.php','softkom-public-acquisition.js','softkom-strategy-request.php','softkom-sales-notifications.php','softkom-industry-funnel.php','softkom-industry-funnel.js','softkom-assessment-standalone.php','softkom-commercial-persistence.php','softkom-funnel-command-centre.php','softkom-campaign-admin-redirect.php','softkom-organic-ai-discovery.php','softkom-organic-growth-pages.php','softkom-organic-growth-expansion.php','softkom-organic-traffic-sprint.php','softkom-acquisition-reinforcement.php','softkom-search-discovery.php','softkom-organic-attribution.php','softkom-indexnow.php','softkom-automated-qa.php'
)
...
$robots=Join-Path $root 'robots.txt';if(-not(Test-Path $robots)){throw "Required physical robots.txt is missing: $robots"};Copy-Item $robots -Destination (Join-Path $deploy 'robots.txt') -Force
...
Write-Host 'Bundle includes physical robots.txt and acquisition sitemap, assessment runtime, organic/AI discovery and attribution, search discovery/internal linking, Sprint 2 acquisition reinforcement, IndexNow notifications, scheduled automated funnel QA, high-intent organic growth pages, expansion pages and organic traffic sprint pages, acquisition, commercial persistence, funnel command centre, campaign admin MU plugins and release QA.' -ForegroundColor Cyan
