...
$slugs=array('assessment','ai-automation-south-africa','business-process-automation-south-africa','custom-business-systems-south-africa','ai-automation-for-smes-south-africa','replace-spreadsheets-manual-processes-south-africa','sales-lead-generation-automation-south-africa','whatsapp-customer-service-automation-south-africa','ai-readiness-assessment-south-africa','replace-excel-with-custom-software-south-africa','custom-software-vs-spreadsheets','automate-manual-business-processes','business-system-integration-south-africa');
$required=array(
...
qa_check(substr_count($sitemap,'<loc>')===13,'Physical sitemap contains exactly 13 acquisition URLs');
...
qa_check(strpos($indexnow,'Queue All 13 Acquisition URLs')!==false&&strpos($indexnow,'softkom_indexnow_submit_all')!==false,'Manual IndexNow recovery control present');
