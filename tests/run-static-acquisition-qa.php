...
qa_check(strpos($search,'Sales & Lead Automation South Africa | Softkom')!==false&&strpos($search,'Automate Lead Follow-Up South Africa | Softkom')!==false&&strpos($search,'Operations Management System South Africa | Softkom')!==false&&strpos($search,'Replace Excel with Custom Software South Africa | Softkom')!==false,'Commercial search snippets cover four high-intent buyer pages');
